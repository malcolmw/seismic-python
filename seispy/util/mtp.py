...
.. module:: seispy.util.mtp
   :synopsis: A module to support multithreaded processing.

.. moduleauthor:: Malcolm White <mcwhite@ucsd.edu>
.. versionadded:: 0.0alpha

This module supports multithreaded processing.

.. autoclass:: seispy.util.mtp.MultiThreadProcess
